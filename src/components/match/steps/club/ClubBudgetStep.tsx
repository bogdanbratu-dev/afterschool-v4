...
export default function ClubBudgetStep({ draft, update }: ClubStepProps) {
  return (
    <div>
      <h2 className="font-display text-xl sm:text-2xl font-bold text-[var(--color-text-main)] mb-1">Bugetul pentru activitate</h2>
      <p className="text-sm text-[var(--color-text-light)] mb-6">Cât ești dispus(ă) să plătești?</p>
      <div className="flex flex-col gap-2.5">
        {CLUB_BUDGET_BUCKETS.map((b) => {
