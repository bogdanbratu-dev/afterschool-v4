...
export default function ClubLocationStep({ draft, update }: ClubStepProps) {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--color-text-light)] mb-6">Căutăm activități aproape de tine.</p>
