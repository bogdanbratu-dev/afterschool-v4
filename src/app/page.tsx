      ...
      <main className="max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-8 pb-safe-bottom">
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-6 gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] active:opacity-90 text-white rounded-xl text-sm font-semibold shadow-md transition-all md:hidden"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
            </svg>
            Filtreaza dupa 6 criterii
