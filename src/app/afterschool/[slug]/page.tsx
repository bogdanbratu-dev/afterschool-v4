              ...
              <div className="pt-4 border-t border-[var(--color-border)]">
                {contactHidden ? (
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    {(as as any).facebook_url && (
                      <a href={(as as any).facebook_url} target="_blank" rel="noopener noreferrer nofollow" className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-lg transition-colors">
